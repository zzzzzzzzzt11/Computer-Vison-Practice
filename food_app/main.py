...
model = tf.keras.models.load_model('C:/Users/stud/Desktop/food_app/models/101_food_class_10_percent_saved_big_dog_model.keras')
...
# Streamlit app
st.title('My Food Classification APP')
